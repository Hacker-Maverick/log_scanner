...
class LogScanner:
    ...
    def generate_header(self) -> Panel:
        return Panel(Align.center(Text("LOG_SCANNER v3.5 - ENTERPRISE NETWORK AUDITOR", style="bold white on blue")), style="blue")
...
if __name__ == "__main__":
    ...
    auditor = LogScanner(interface=args.interface, save_results=args.save)
    auditor.start()